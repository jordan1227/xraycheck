...
>  ⚠️ **Для успешного добавления/обновления подписки в условиях CIDR-ограничений
>  необходимо использовать ссылку с использованием зеркала (кнопка копирования рядом с текстом Mirror на сайте)** 
