...
>  ⚠️ **Для успешного обновления подписки в условиях CIDR-ограничений:**
> 
>  ⚠️ **необходимо использовать ссылку с использованием зеркала (кнопка копирования рядом с текстом Mirror на сайте)** ⚠️

****

> ⚠️ **Показатели доступности и перечень рабочих конфигов могут быть разными в зависимости от региона использования** ⚠️
> 
> ⚠️ **Перед началом использования необходимо каждый раз производить проверку доступности средствами VPN-клиента** ⚠️
>
